...
public abstract class Hero {
    ...
    //是否被持续伤害
    private boolean continousDamaging = true;
    //你的血量
    private int hp;
    ...
    public boolean isContinousDamaging(){return continousDamaging;}

    public void setContinousDamaging(boolean continousDamaging,int damaging){

        this.continousDamaging = continousDamaging;

        this.reduceHp(damaging);
    }
     ...
     */
    protected Hero(String name, String stuid, int strength, int agility, int intelligence,int exp,int level) {
